================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : SpamProtector Project Overview
===============================================================================

The application wizard has created this SpamProtector application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your SpamProtector application.

SpamProtector.vcproj
...
SpamProtector.h
    ...
    project specific headers and declares the CSpamProtectorApp application class.

SpamProtector.cpp
    This is the main application source file that contains the application
    class CSpamProtectorApp.
...
res\SpamProtectorsp.rc2
    This file contains resources that are not edited by Microsoft 
    Visual C++. You should place all resources not editable by
    the resource editor in this file.

res\SpamProtector.ico
...
SpamProtectorDlg.h, SpamProtectorDlg.cpp - the dialog
    These files contain your CSpamProtectorDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named SpamProtector.pch and a precompiled types file named StdAfx.obj.
