========================================================================
    STATIC LIBRARY : LibConfigSpamProtector Project Overview
========================================================================

AppWizard has created this LibConfigSpamProtector library project for you. 

This file contains a summary of what you will find in each of the files that
make up your LibConfigSpamProtector application.


LibConfigSpamProtector.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    named LibConfigSpamProtector.pch and a precompiled types file named StdAfx.obj.
...
project, including "resource.h", "LibConfigSpamProtector.rc" and a "LibConfigSpamProtector.h" that 
